...
print(X)
```
#### 3.2.2. Train K-means Clustering Model
...
3       0  48   0
```
출력 결과를 보면 군집이 잘 이루어 진것을 확인 할 수 있습니다.  
...
```
![3_n_clusters](./result/3_n_clusters.png)
#### 3.2.2. Output inertia value by number of clusters
